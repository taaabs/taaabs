declare const styles: {
  ...
  readonly 'item--recently-visited': string
  readonly item__actions: string
  readonly item__actions__menu: string
  readonly item__actions__menu__button: string
  readonly 'item__actions__menu__button--toggled': string
