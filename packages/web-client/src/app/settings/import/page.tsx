...
const Page: React.FC = () => {
  ...
  return (
    <>
      {!import_hook.netscape_document && (
        <UiAppAtom_Box>
          <UiAppAtom_BoxHeading
            heading="Import bookmarks"
            subheading='Export can be generated by your web browser, a third-party
            service or "Backups" settings pane.'
          />
          <input type="file" onChange={handle_file_change} />
          <p>
            <small>
              <strong>Privacy note:</strong> Chosen file will be validated
              locally. In the next step you will be asked to set visibility for
              all imported bookmarks and confirm file upload. Until then, no
              data will leave your device.
            </small>
          </p>
        </UiAppAtom_Box>
      )}
      ...
      {import_hook.parsed_bookmarks && (
        <>
          <UiAppAtom_Box>
            ...
            <p>
              {import_hook.parsed_bookmarks.length} bookmarks ready to be
              imported.
            </p>
            <div>
