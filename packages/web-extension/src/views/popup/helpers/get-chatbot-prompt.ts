export const get_chatbot_prompt = (params: {
  ...
  if (params.prompt_id == '1') {
    ...
    prompt = `Your first response should be solely: "Hi! What question do you have?" After I provide a question, please answer it with both a concise summary and a detailed explanation.\n\n---\n\n${params.plain_text}`
