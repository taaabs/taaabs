export const get_chatbot_prompt = (params: {
  ...
  if (params.prompt_id == '1') {
    ...
    prompt = `In your response simply ask me what question do I have regarding the page and stop there. When answering it, provide both a concise and a detailed answer. You can use the knowledge you have on the matter.\n\n---\n\n${params.plain_text}`
